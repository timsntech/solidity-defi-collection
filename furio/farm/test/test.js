...
var deployedAddress = {
  ...
  token: "0x851AFC4bf868A010678D00ce3Cc6FEe6C49080C8",
  masterChef: "0xee6F7CDFC42DBc2a496bAdc9AeC5d304dE8BB9b8",
  masterChefV2: "0x26A68F58D8FB1aaebb3C2091D6e3fB1118e4e1E5",
  stakingPool: "0x8fC7B0CC23Bcd3480931B3039b6CDD4543c40D0A",
  refferal: "0xe7DdF4e46dD384b2aB9AaF9523322Fd38f4EA9B3",
  averagePriceOracle: "0xB12eaABE02DdabE65954cf7C3D770C32EEd2e58F",
  dex: "0xab63f6d7867c59917CEf781b02557796eeCdf4C4",
  furiofi: "",
};
...
var lpAddresses = {
  ...
  furFi_bnb_lp: "0x3E664593Bfeb78D2AF12A55b000C3bF139eC352F",
};
...
/** For token deployment
  ...
  user3 0x067522f6ef963768Ad49e66a0eC2f9C117990742
...
describe("Contract deployment and setting for farming", () => {
  ...
  //   var Furiofi = await ethers.getContractFactory("Furiofi");
  //   if (!isOnchain) {
  //     //for hardhat test
  ...
  //     //set role
  //     var tx = await furiofi.grantRole(
  //       keccak256("UPDATER_ROLE"),
  //       owner.address
  //     );
  //     await tx.wait();
