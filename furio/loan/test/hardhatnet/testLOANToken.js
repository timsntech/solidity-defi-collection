...
var communityIssuanceAddress = "0x71d51C76121dD6c0bA30d2C57802c6bF097EcAD8";
var loanStakingAddress = "0xB1C87ECE86a0ED0353f287afB1EE88A5032797DB";
var bountyAddress = "0xE2B4ECdE7f36c46c0Bf34E6890290412E29552a8"; 
...
describe("Contracts deploy", () => {
 // ------ dex deployment ------- //
  ...
  it("Token deploy", async () => {
    Token = await ethers.getContractFactory("LOANToken");
    token = await upgrades.deployProxy(Token, [communityIssuanceAddress, loanStakingAddress, bountyAddress]);
...
describe("test ", () => {
    ...
    //   var tx = await token.connect(user2).approve(exchangeRouter.address, toBigNum("10", 18));
    //   await tx.wait();
