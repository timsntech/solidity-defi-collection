...
contract TokenV2 is BaseContract, ERC20Upgradeable {
    /**
    ...
    function allowSwap(address addr, bool value) external zeroAddressCheck(addr) onlyOwner
    {
    ...
    function swapBusdForToken(uint256 amountIn, uint256 amountOutMin) external
    {
        ...
        liquidityManager.swapBusdForToken(_msgSender(), amountIn, amountOutMin);
    ...
    {
        _setSwapAllowed(_msgSender(), true);
        liquidityManager.swapTokenForBusd(_msgSender(), amountIn, amountOutMin);
        _setSwapAllowed(_msgSender(), false);
    }
